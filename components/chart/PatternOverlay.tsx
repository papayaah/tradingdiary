...
export default function PatternOverlay({
  ...
  return (
    <div className="absolute top-3 left-3 z-20 flex items-center gap-2 bg-card-bg/90 backdrop-blur-md border border-card-border px-3 py-1.5 rounded-xl shadow-lg text-xs animate-in fade-in slide-in-from-top-2 duration-200">
