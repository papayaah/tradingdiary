...
- ✅ **Step 1 — Normalized tables.** `server_watch`, `server_watch_state`, `server_watch_alert`, `scanner_heartbeat`, `watch_event`, and `user_push_subscription` live in PostgreSQL.
